...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="description" content="Sensor House le ofrece productos de vídeo vigilancia para su hogar y negocio."/>
        <meta name="keywords" content="empresa, seguridad, monitoreo, vigilancia, camara ip " />
